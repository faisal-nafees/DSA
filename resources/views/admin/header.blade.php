    ...
    <ul class="navbar-nav">
        ...
        <li class="nav-item d-none d-sm-inline-block">
            <a href="{{ route('dashboard') }}"
                class="nav-link {{ Route::currentRouteName() === 'dashboard' ? 'text-danger' : '' }}">Home</a>
        </li>
        <li class="nav-item d-none d-sm-inline-block">
            <a href="{{ route('enquiry.manage') }}"
                class="nav-link {{ Route::currentRouteName() === 'enquiry.manage' || Route::currentRouteName() === 'enquiry.add' ? 'text-danger' : '' }}">Enquiries</a>
        </li>
        <li class="nav-item d-none d-sm-inline-block">
            <a href="{{ route('contact.manage') }}"
                class="nav-link {{ Route::currentRouteName() === 'contact.manage' ? 'text-danger' : '' }}">Contact</a>
        </li>
        <li class="nav-item d-none d-sm-inline-block">
            <a href="{{ route('user.manage') }}"
                class="nav-link {{ Route::currentRouteName() === 'user.manage' || Route::currentRouteName() === 'user.add' ? 'text-danger' : '' }}">Users</a>
        </li>
        <li class="nav-item d-none d-sm-inline-block">
            <a href="{{ route('editProfile') }}"
                class="nav-link {{ Route::currentRouteName() === 'editProfile' ? 'text-danger' : '' }}">Profile</a>
        </li>
        <li class="nav-item d-none d-sm-inline-block">
            <a href="{{ route('task.manage') }}"
                class="nav-link {{ Route::currentRouteName() === 'task.manage' || Route::currentRouteName() === 'task.add' ? 'text-danger' : '' }}">Task</a>
        </li>
        <li class="nav-item d-none d-sm-inline-block">
            <a href="{{ route('reporting') }}"
                class="nav-link {{ Route::currentRouteName() === 'reporting' ? 'text-danger' : '' }}">Reporting</a>
        </li>
        <li class="nav-item d-none d-sm-inline-block">
