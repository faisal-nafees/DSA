        ...
        <form id="editEnquiryForm" class="form-horizontal" action="{{ route('enquiry.edit', ['id' => $enquiry->enq_id]) }}"
            ...
            <div class="card-body">
                ...
                <div class="row">
                    ...
                    <div class="form-group row col-md-6">
                        <label for="enqSource" class="col-sm-4 col-form-label">Enquiry Source</label>
                        <div class="col-sm-8 err_msg">
                    ...
                    <div class="form-group row col-md-6">
                        ...
                        <div class="col-sm-8 err_msg">
                            <input type="text" class="form-control" id="fullname" name="fullname"
                                value="{{ $enquiry->fullname }}" placeholder="Full Name">
                        </div>
                    </div>
                    <div class="form-group row col-md-6">
                ...
                <div class="row">
                    <div class="form-group row col-md-6">
                        ...
                        <div class="col-sm-8 err_msg">
                            <input type="text" class="form-control" name="mobile" value="{{ $enquiry->mobile }}"
                    ...
                    <div class="form-group row col-md-6">
                        ...
                        <div class="col-sm-8 err_msg">
                            <input type="text" class="form-control" name="whatsapp" value="{{ $enquiry->whatsapp }}"
                ...
                <div class="row">
                    ...
                    <div class="form-group row col-md-6">
                        ...
                        <div class="col-sm-8 err_msg">
                            <input type="text" class="form-control" name="address" value="{{ $enquiry->address }}"
